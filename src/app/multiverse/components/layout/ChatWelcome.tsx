  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-8 pt-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute right-1/4 top-20 w-96 h-96 bg-emerald-500/[0.03] rounded-full blur-3xl"></div>
        <div className="absolute left-1/4 bottom-20 w-64 h-64 bg-emerald-500/[0.02] rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="flex flex-col items-center max-w-3xl w-full mx-auto relative z-10">
        ...
        <div className="text-center mb-16 -mt-12 relative">
          ...
          <h1 className="text-3xl font-medium text-gray-800 dark:text-white mb-2 flex items-center justify-center gap-2">
            ...
            {userName && (
              <>
                , <span className="text-emerald-500 font-semibold relative">{userName}
                  <svg className="h-5 w-5 text-emerald-500 absolute -top-4 -right-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="h-px w-20 bg-emerald-200 dark:bg-emerald-700 mx-auto mb-3"></div>
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs mx-auto">
            Discover <span className="text-emerald-500 font-medium">winning products</span> for your e-commerce business
          </p>
        </div>
        ...
        <div className="w-full mb-16 max-w-3xl mx-auto">
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div 
                ...
                className="flex items-center gap-3 rounded-md border border-emerald-100 bg-white/80 p-4 cursor-pointer hover:border-emerald-200 hover:bg-emerald-50/50 transition-all platform-icon"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                {/* Icon with emerald color */}
          ...
          <div className="mt-6 rounded-md border border-emerald-100 bg-white/80 p-4 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500">
                ...
                <div className="flex items-center">
                  <div className="inline-flex items-center gap-1">
                    <div className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs bg-emerald-50 border border-emerald-100">
                      <span className="text-emerald-700">New</span>
                    </div>
                    <div className="inline-flex items-center px-2 py-0.5 rounded-full text-xs bg-emerald-50 border border-emerald-100">
                      ...
                      <span className="text-emerald-700">v1.0.6</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-600">Added token usage tracking with detailed breakdown</p>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-xs text-emerald-500 mt-0.5">•</span>
                  <p className="text-xs text-gray-600">New UI component showing token counts and costs</p>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-xs text-emerald-500 mt-0.5">•</span>
                  <p className="text-xs text-gray-600">Refreshed addon pill with emerald design</p>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-xs text-emerald-500 mt-0.5">•</span>
                  <p className="text-xs text-gray-600">Fixed duplicate message saving in chat history</p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-3 relative rounded-md overflow-hidden p-4 opacity-60 backdrop-blur-sm">
            {/* Gradient border with emerald */}
            <div className="absolute inset-0 bg-gradient-to-b from-emerald-100 via-emerald-50/30 to-transparent pointer-events-none"></div>
            
            {/* Content with fading background */}
            <div className="relative bg-white/80 rounded-t-md">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="opacity-70 text-emerald-700">
                ...
                {/* Version Pill - Faded */}
                <div className="inline-flex items-center px-2 py-0.5 rounded-full text-xs bg-emerald-50/80 border border-emerald-100/50">
                  <span className="text-emerald-600/70">v1.0.5</span>
                </div>
              </div>
              
              <ul className="space-y-1.5 pb-4 opacity-80">
                <li className="flex items-start gap-2">
                  <span className="text-[10px] text-emerald-300 mt-0.5 opacity-60">•</span>
                  <p className="text-[10px] text-gray-500">Modern UI themes with clean design</p>
                </li>
                <li className="flex items-start gap-2 opacity-70">
                  <span className="text-[10px] text-emerald-300 mt-0.5 opacity-60">•</span>
                  <p className="text-[10px] text-gray-500">Added product image analysis capability</p>
                </li>
                <li className="flex items-start gap-2 opacity-70">
                  <span className="text-[10px] text-emerald-300 mt-0.5 opacity-60">•</span>
                  <p className="text-[10px] text-gray-500">Fixed issues with network connectivity</p>
                </li>
              </ul>
